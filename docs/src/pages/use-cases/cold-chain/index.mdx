...
This is not really one click, but one shell script. Go to the [vaccine-gitops] folder and do the following steps:
...
* Start `./scripts/deployColdChainWithEentStreams.sh --skip-login`
...
* Go to the [demonstration section](#scenario_script) to run the demo.
