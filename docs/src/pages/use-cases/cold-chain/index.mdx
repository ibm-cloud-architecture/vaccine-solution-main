...
1. Create a ConfigMap named `agent-cm` to hold the configuration for the Vaccine Monitoring Agent microservice with the following `oc` command:
  ...
  --from-literal=TEMPERATURE_THRESHOLD=-50.0 \
