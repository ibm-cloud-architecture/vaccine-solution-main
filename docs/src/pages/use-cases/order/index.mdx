...
In the vaccine-gitops see the [readme file](https://github.com/ibm-cloud-architecture/vaccine-gitops) to deploy a 3 brokers cluster, with Kafka user using TLS authentication, and the Kafka topics needed by the solution.
