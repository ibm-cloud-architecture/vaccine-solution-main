...
![confusion-matrix](images/a_Confution Matrix_1.png)

The tool offers nice capabilities like the feature transformation:

![feature-transform](images/a_Feature Transformation_1.png)

And the feature importance ranking, which helps to assess what are the features that impact the classification.

![feature-importance](images/a_Feature Importance_1.png)

Depending upon the accuracy or performance the best model can be selected and saved 

![feature-importance](images/a_model save_1.png)
