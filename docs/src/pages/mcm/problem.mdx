...
Those capabilities add agility to select the target cloud provider, to continuously reduce the cost.


### Learn more about IBM Cloud Pak® for Multicloud Management


We recommend to go over the [MCM cookbook content](https://cloudpak8s.io/mcm/cp4mcm_introduction/) in the [cloud pak playbook](https://cloudpak8s.io/).
