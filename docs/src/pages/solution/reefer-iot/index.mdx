...
The simulator needs to integrate with kafka / IBM Event Streams deployed as service on the cloud or deployed on OpenDshift cluster using Cloud Pak for Integration.
