...
2. You have to ensure that in OpenPages a Model is created with all fields as needed in the following workflows. The list of the fields you can see in the diagram below -

![topic](./images/MDLCModelFields.jpg)
