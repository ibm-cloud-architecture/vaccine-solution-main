...
11. To the project add the Data Asset from the Catalog. 
12. Use Refinery to do the feature engineering as provided in the Solution section. Add the Anomaly Flag. Alyternatively one can use Notebooks or SPSS Modleer for the Feature Engineering.
13. Publish the Feature Engineered Data to Catalog. Give the Data Asset an appropriate name and tag it appropriately. Also publish the Data Refinery Flow (export from project and import as data asset) to the Catalog.
...
15. Login to OpenPages. Go to the Model. Check the name of the Feature Engineered Data Asset for model development. Go to the Catalog. Review the Data Asset
