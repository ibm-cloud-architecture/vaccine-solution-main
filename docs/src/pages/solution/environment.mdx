...
* A DB2 instance is created on IBM Cloud. See [those instructions](https://cloud.ibm.com/docs/Db2onCloud?topic=Db2onCloud-getting-started) to get a service up and running.
