...
The vaccine order stipulates to have a great number of vaccine lots to be delivered to any place in the world. The order may have priority, which invokes a series of complex optimization plans:
